...
ALTER TABLE `t_booking` ADD CONSTRAINT FK_User FOREIGN KEY (b_user_id) REFERENCES `t_users`(id); 

INSERT INTO `t_users` (u_name, u_firstname, u_phone, u_email, u_password, u_role)
    VALUES (
        "Villiere", "Emilie", "06-00-00-00-00", "emilie.vllr@gmail.com", "webforce3", 1
);

INSERT INTO `t_users` (u_name, u_firstname, u_phone, u_email, u_password, u_role)
VALUES (
    "Zona", "Solenne", "06-00-00-00-00", "solenne.zona@gmail.com", "webforce3", 1
);

INSERT INTO `t_booking` (b_title, b_subtitle, b_description, b_city, b_surface, b_price, b_type, b_swim, b_image_1, b_image_2, b_image_3, b_user_id)
    VALUES (
        ...
        "Palavas-les-Flots", 47, 99, "appartement", 0, "1-house1.jpg", "1-kitchen1.jpg", "1-saloon1.jpg", 1
    );
...
INSERT INTO `t_booking` (b_title, b_subtitle, b_description, b_city, b_surface, b_price, b_type, b_swim, b_image_1, b_image_2, b_image_3, b_user_id)
    VALUES (
        ...
        "Que dire de plus.. c'est près de la mer, il y a du vent en facade mais pas dans la cour sécurisée, vous pourrez laisser les gosses s'amuser, pas de problèmes !",
        "Saint-Tropez", 150, 245, "maison", 0, "2-house-2.jpg", "2-bathroom2.jpg", "2-saloon2.jpg", 1
    );
...
INSERT INTO `t_booking` (b_title, b_subtitle, b_description, b_city, b_surface, b_price, b_type, b_swim, b_image_1, b_image_2, b_image_3, b_user_id)
    VALUES (
        ...
        "Que dire de plus.. c'est près de la mer, il y a du vent en facade mais pas dans la cour sécurisée, vous pourrez laisser les gosses s'amuser, pas de problèmes !",
        "Cannes", 78, 112, "appartement", 1, "3-house3.jpg", "3-kitchen3.jpg", "3-saloon3.jpg", 1
    );
...
INSERT INTO `t_booking` (b_title, b_subtitle, b_description, b_city, b_surface, b_price, b_type, b_swim, b_image_1, b_image_2, b_image_3, b_user_id)
    VALUES (
        ...
        "Que dire de plus.. c'est près de la mer, il y a du vent en facade mais pas dans la cour sécurisée, vous pourrez laisser les gosses s'amuser, pas de problèmes !",
        "Sain-tropez", 117, 265, "maison", 0, "4-garden4.jpg", "4-kitchen4.jpg", "4-saloon4.jpg", 2
    );
...
INSERT INTO `t_booking` (b_title, b_subtitle, b_description, b_city, b_surface, b_price, b_type, b_swim, b_image_1, b_image_2, b_image_3, b_user_id)
    VALUES (
        ...
        "Que dire de plus.. c'est près de la mer, il y a du vent en facade mais pas dans la cour sécurisée, vous pourrez laisser les gosses s'amuser, pas de problèmes !",
        "Palavas-les-Flots", 94, 149, "maison", 0, "5-house5.jpg", "5-playa5.jpg", "5-saloon5.jpg", 2
    );
...
INSERT INTO `t_booking` (b_title, b_subtitle, b_description, b_city, b_surface, b_price, b_type, b_swim, b_image_1, b_image_2, b_image_3, b_user_id)
    VALUES (
        ...
        "Que dire de plus.. c'est près de la mer, il y a du vent en facade mais pas dans la cour sécurisée, vous pourrez laisser les gosses s'amuser, pas de problèmes !",
        "Saint-raphael ", 38, 75, "appartement", 1, "6-house-6.jpg", "6-saloon-6.jpg", "6-swim6.jpg", 2
    );
